...
export const activityRoutes = {
  ...
  profileQuestion2: '/perfil/preguntas/2',
  profileQuestion3: '/perfil/preguntas/3',
  profileQuestion4: '/perfil/preguntas/4',
  profileQuestion5: '/perfil/preguntas/5',
  profileQuestion6: '/perfil/preguntas/6',
  profileQuestion7: '/perfil/preguntas/7',
  profileThanks: '/perfil/gracias',
  home: '/actividades',
...
const SCREEN_TITLES: Readonly<Record<string, string>> = {
  ...
  [activityRoutes.profileQuestion2]: 'Pregunta de perfil 2',
  [activityRoutes.profileQuestion3]: 'Pregunta de perfil 3',
  [activityRoutes.profileQuestion4]: 'Pregunta de perfil 4',
  [activityRoutes.profileQuestion5]: 'Pregunta de perfil 5',
  [activityRoutes.profileQuestion6]: 'Pregunta de perfil 6',
  [activityRoutes.profileQuestion7]: 'Pregunta de perfil 7',
  [activityRoutes.profileThanks]: 'Gracias por contarnos más',
